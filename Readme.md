...
**Tap Tempo** – это веб-приложение (PWA), которое позволяет музыкантам, диджеям и всем, кто работает с ритмом, быстро определить темп (BPM) любой песни простым нажатием на кнопку в такт. Все данные хранятся локально в браузере, приложение работает офлайн и может быть установлено на рабочий стол как нативное.
